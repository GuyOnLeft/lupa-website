  ...
  return (
    <section style={{ padding: "80px 0", background: "#0a0a0a" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 32px" }}>
        ...
        <h2 style={{ fontSize: 32, fontWeight: 700, color: "#fff", marginBottom: 48, fontFamily: "Inter, sans-serif", letterSpacing: "-0.01em" }}>From public record to ranked lead.</h2>
        <div ref={ref} style={{ display: "grid", gridTemplateColumns: "1fr 48px 1fr 48px 1fr" }}>
          {STEPS.map((step, i) => (
            <React.Fragment key={step.num}>
              <div style={{ background: "#0d0d0d", border: "1px solid #1e1e1e", borderRadius: 4, padding: 24, opacity: visible ? 1 : 0, transform: visible ? "translateY(0)" : "translateY(24px)", transition: `opacity 0.5s ease ${i * 0.15}s, transform 0.5s ease ${i * 0.15}s` }}>
